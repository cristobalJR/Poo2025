 ...
 * siguiente pantalla que hay que mostrar(metodo show).
 */
// EXTENSION ->
/**
...
public abstract class Screen {
    ...
    // EXTENSION -> Referencia a la pantalla física del kiosco (la librería). Es de paquete
    ...
    protected void configureButtons() {
        for (char option = 'A'; option <= 'U'; option++) {
            kiosk.setOption(option, null); // EXTENSION -> null borra el botón
        }
    }
