...
public class OperationContext {
    ...
    private boolean largeFamily;                         // EXTENSION -> ¿tiene tarjeta de familia numerosa?
    private Translator translator;                       // EXTENSION -> idioma actual
    private final TranslatorManager translatorManager;   // EXTENSION -> servicio de idiomas
    private final TrainNetwork trainNetwork;             // EXTENSION -> servicio de red / precios
    ...
    public OperationContext(TranslatorManager translatorManager, TrainNetwork trainNetwork) {
        ...
        // EXTENSION -> Arrancamos con el idioma actual del gestor (por defecto, español).
