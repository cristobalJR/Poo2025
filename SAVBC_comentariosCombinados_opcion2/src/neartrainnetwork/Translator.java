...
public class Translator {
    ...
    private final String language;                          // EXTENSION -> nombre del idioma
    private final Map<String, String> dictionary = new HashMap<>(); // EXTENSION -> original -> traducción
    ...
    public String toString() {
        return language; // EXTENSION -> lo que se ve en el botón al elegir idioma
    }
    ...
    private void load(String fileName) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                String[] parts = line.split("\t"); // EXTENSION -> separador: tabulador
                if (parts.length >= 2) {
