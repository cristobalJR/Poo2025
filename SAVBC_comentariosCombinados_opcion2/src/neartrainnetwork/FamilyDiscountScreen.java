...
public class FamilyDiscountScreen extends Screen {
    ...
    private static final char YES = 'A';     // EXTENSION -> botón "Sí"
    private static final char NO = 'B';      // EXTENSION -> botón "No"
    ...
    public Screen show(OperationContext operationContext) {
        ...
        while (true) {
            ...
            switch (event) {
                case YES -> {
                    // EXTENSION -> Tiene tarjeta: se marca el descuento y se pasa al pago.
                    operationContext.setLargeFamily(true);
                    return new PaymentScreen(kiosk);
                }
                case NO -> {
                    // EXTENSION -> No tiene tarjeta: precio normal y al pago.
                ...
                default -> {
                    // EXTENSION -> '0' (sin pulsación) o eventos de tarjeta: seguimos esperando.
                }
            }
        }
    }
